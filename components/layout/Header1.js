                    ...
                    <div className="navik-header-container">
                        ...
                        <nav className="navik-menu menu-caret navik-yellow">
                            <ul className={`top-list ${isToggled ? "d-block" : "d-none"}`}>
                                ...
                                <li><Link href="#about-3" onClick={(e) => {
                                    e.preventDefault();
                                    scrollToId('about-3');
                                }}>About</Link>
                                ...
                                <li><Link href="#brands-1" onClick={(e) => {
                                    e.preventDefault();
                                    scrollToId('brands-1');
                                }}>Partners</Link>
                                ...
                                <li><Link href="#reviews-1" onClick={(e) => {
                                    e.preventDefault();
                            ...
                            <ul className={isToggled ? "d-block" : "d-none"}>
                                ...
                                <li><Link href="#gallery-2" onClick={(e) => {
                                    e.preventDefault();
                                    scrollToId('gallery-2');
                                }}>Gallery</Link>
                                ...
                                <li><Link href="/contacts">Contacts</Link>
